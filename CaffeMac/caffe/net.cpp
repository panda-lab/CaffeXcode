...
const shared_ptr<Layer<Dtype> > Net<Dtype>::layer_by_name(
  ...
  return layer_ptr;
    ...
    inline string create_or_link(std::unordered_map<string, string>& record,
    ...
    inline void exclude_both(std::unordered_map<string, string>& record,
    ...
    void Net<Dtype>::MemoryOptimize_v2(){
        ...
        std::unordered_map<string, string> share_record;
